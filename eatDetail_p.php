            ...
            <div class="member-msg">
                ...
                <div class="comments clearfix">
                    ...
                    <div class="msg-btn">   
                        ...
                        <button type="submit" value="<?php echo $mealNo ?>" name="comments" id="commentsBtn" class="nextBTN">送出</button>
                    </div>
                </div>
            </div>
            <?php
                $sql = "select * from message where meal_No=$mealNo";
