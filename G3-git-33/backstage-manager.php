                ...
                <div class="modal fade" id="manager" tabindex="-1" role="dialog" aria-labelledby="managerTitle" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-content">
                            ...
                            <?php
                                try{
                                    require_once("C:/inetpub/wwwroot/coll/connectmenu.php");
                                            ...
                                            <div class="modal-body">
                                                <form method="post" action="managerAuth.php">
                                                    ...
                                                    <div class="d-flex form-group">
                                                        ...
                                                        <input type="text" class="form-control change" id="viewManagerId<?php echo $rowmanager["manager_No"]?>" value="<?php echo $rowmanager["manager_Id"]?>" >
                                                    </div>
                                                    <div class="d-flex form-group">
